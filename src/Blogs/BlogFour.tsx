    ...
    return (
        <>
            <div className="max-w-3xl mx-auto p-6">
                <h1 className="text-3xl font-bold mb-2">What Does Auto Detailing Include?</h1>
                <p className="text-gray-600 mb-4">By<br />March 24, 2025</p>
                <p className="mb-4">
                ...
                <p className="mb-4">
                    An exterior wash is more than just rinsing the car with water. It involves a methodical process using high-quality detergents that not only cleanse but also protect the paintwork...
                </p>
                <h2 className="text-2xl font-semibold mb-2">Paint Claying</h2>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-semibold mb-2">Polishing</h2>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-semibold mb-2">Waxing</h2>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-semibold mb-2">Thorough Interior Cleaning</h2>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-semibold mb-2">Glass Cleaning</h2>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-semibold mb-2">Engine Bay Cleaning</h2>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-semibold mb-2">Final Thoughts on Auto Detailing</h2>
                <p className="mb-4">
